...
class HubMessageNonceChallengeRequestPayloadHandler: HubMessagePayloadHandlerBase<HubMessageNonceChallengeRequestPayload> (HubMessageNonceChallengeRequestPayload::class.java) {
